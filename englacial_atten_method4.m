...
if 1
    in_fn=['/cresis/snfs1/scratch/manjish//peterman/verticalline_w_idx.mat'];
    load(in_fn);
end
physical_constants
plots =0;
...
for M =21:40
  ...
  clearvars -except M Na plots ice_bed_power_G_r_corrected lat_G_r_corrected lon_G_r_corrected depth_G_r_corrected cross_lines constant_attenuation estimated_Na var_attn estimated_Na_mod
  clc
