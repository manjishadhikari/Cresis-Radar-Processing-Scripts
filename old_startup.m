...
if ~(~ismcc && isdeployed)
  ...
  profile(pidx).personal_path             = '/users/manjish/scripts/matlab/';
  profile(pidx).ct_path                   = '/users/manjish/scripts/cresis-toolbox/cresis-toolbox/';
  profile(pidx).param_path                = '/users/manjish/scripts/ct_params/';
  
  profile(pidx).code_path                 = profile(pidx).ct_path;
  profile(pidx).code_path_override        = profile(pidx).personal_path;
  profile(pidx).tmp_file_path             = '/cresis/snfs1/scratch/manjish/mdce_tmp/';
  ...
  profile(pidx).sched.data_location       = '/cresis/snfs1/scratch/manjish/mdce_tmp/torque-temp';
  ...
  profile(pidx).sched.worker_fn           = '/users/manjish/scripts/cresis-toolbox/cresis-toolbox-torque/worker';
  ...
  profile(pidx).debug_level               = 1;
  profile(pidx).personal_path             = '/N/u/jmanjish/Karst/scripts/matlab/';
  profile(pidx).ct_path                   = '/N/u/jmanjish/Karst/scripts/cresis-toolbox/cresis-toolbox/';
  profile(pidx).param_path                = '/N/u/jmanjish/Karst/scripts/ct_params/';
  
  profile(pidx).code_path                 = profile(pidx).ct_path;
  profile(pidx).code_path_override        = profile(pidx).personal_path;
  profile(pidx).tmp_file_path             = '/N/dc2/scratch/manjish/mdce_tmp/';
  ...
  profile(pidx).sched.data_location       = '/N/dc2/scratch/jmanjish/matlab_torque/';
  ...
  profile(pidx).sched.stop_on_fail        = true;
  profile(pidx).sched.max_retries         = 4;
  profile(pidx).sched.worker_fn           = '/N/u/jmanjish/Karst/scripts/cresis-toolbox/cresis-toolbox-torque/worker';
  profile(pidx).sched.force_compile       = false;
  profile(pidx).sched.rerun_only          = false;
  ...
  profile(pidx).debug_level               = 1;
  profile(pidx).personal_path             = 'C:\Users\manjish\Documents\scripts\matlab\';
  profile(pidx).ct_path                   = 'C:\Users\manjish\Documents\scripts\cresis-toolbox\cresis-toolbox\';
  profile(pidx).param_path                = 'C:\Users\manjish\Documents\scripts\ct_params\';
  ...
  %% KU Desktop Profile Windows (PROFILE 6)
  % ----------------------------------------------------------------------
  % H:\ --> \\emperor.cresis.ku.edu\manjish\
  ...
  profile(pidx).code_path                 = profile(pidx).ct_path;
  profile(pidx).code_path_override        = profile(pidx).personal_path;
  profile(pidx).tmp_file_path             = 'Y:/manjish/mdce_tmp/';
  ...
  gRadar.sched.hidden_depend_funs{end+1} = {'get_heights_task.m' 2};
    gRadar.sched.hidden_depend_funs{end+1} = {'save_data_features_task.m' 2};
      gRadar.sched.hidden_depend_funs{end+1} = {'roughness_cal_from_radar_v2.m' 2};
