...
param_override.sched.submit_arguments    = ' -l nodes=1:ppn=1,walltime=00:59:00 ';
...
param_override.lines=[28];    %eg {Jacobshavn 1:103 vl and 1:74 cl) { Peterman==> {1:29} crossline and {1:20}vertical}
