...
param_override.sched.submit_arguments    = '-q mem -l nodes=1:ppn=1,walltime=02:00:00 ';
...
param_override.lines=[1:29];    %eg {1:36 jacob vl   1:25 cl) { Peterman==> {1:29} crossline and {1:20}vertical}
