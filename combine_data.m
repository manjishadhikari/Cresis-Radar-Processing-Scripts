...
for M =1:40
  if M<21
    tmp=load(['/cresis/snfs1/scratch/manjish/peterman/radar/crossline', sprintf('%d.mat',M)]);
  else
    N=M-20;
    tmp= load(['/cresis/snfs1/scratch/manjish/peterman/radar/verticalline', sprintf('%d.mat',N)]);
  end
...
out_fn=['/cresis/snfs1/scratch/manjish/peterman/', sprintf('completedata.mat')];
