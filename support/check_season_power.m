...
data2010=load(['/cresis/snfs1/scratch/manjish/new_peterman/data/data_2010.mat']);
data2011=load(['/cresis/snfs1/scratch/manjish/new_peterman/data/data_2011.mat']);
%data2012=load(['/cresis/snfs1/scratch/manjish/new_peterman/data/data_2012.mat']);

% data2013=load(['/cresis/snfs1/scratch/manjish/new_peterman/data_2013.mat']);
% 
% data2014=load(['/cresis/snfs1/scratch/manjish/new_peterman/data_2014.mat']);

%   data2010_coh=load(['/cresis/snfs1/scratch/manjish/new_peterman/data_2010_coh_int.mat']);
%     data2011_coh=load(['/cresis/snfs1/scratch/manjish/new_peterman/data_2011_coh_int.mat']);
%
     comb_data=load(['/cresis/snfs1/scratch/manjish/new_peterman/data/combined_data.mat']);
 %    vert_data=load(['/cresis/snfs1/scratch/manjish/new_peterman/verticalline_w_idx.mat']);
  %  cross_data=load(['/cresis/snfs1/scratch/manjish/new_peterman/crossline_w_idx.mat']);
