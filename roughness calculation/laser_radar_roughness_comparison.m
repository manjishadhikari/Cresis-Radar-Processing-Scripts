...
if 0                %Save final laser radar roughness
  if cross_line==1
    save_dest=fullfile(base_path_sr,'manjish','peterman','final', ['crossline',sprintf('%s.mat',num2str(lno))]);
    save(save_dest,'laser_rms','radar_rms','lat','lon','icessn','settings','r');
    disp(sprintf('Saving crossline_%s\n',num2str(lno)));
  else
      save_dest=fullfile(base_path_sr,'manjish','peterman','final', ['verticalline',sprintf('%s.mat',num2str(lno))]);
    save(save_dest,'laser_rms','radar_rms','lat','lon','icessn','settings','r');
